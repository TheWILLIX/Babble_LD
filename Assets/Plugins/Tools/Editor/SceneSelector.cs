...
{
    private const string _scenesFolderPath = "Assets/Babbles/Scenes";
    ...
    private bool _isAutoPlayModeEnabled = false;
    ...
    private void SaveLoadOpenedScenes(PlayModeStateChange state)
    {
        if (state == PlayModeStateChange.EnteredEditMode)
        {
            ...
            while (!stream.EndOfStream)
            {
                ...
                if (isFirstElement && line != "true" && line != "false")
                {
                ...
                if (line == "true")
                {
                    _isAutoPlayModeEnabled = true;
                }
                else if (line == "false")
                {
                    _isAutoPlayModeEnabled = false;
                }
            }
            stream.Close();
        }
        else if (state == PlayModeStateChange.ExitingEditMode)
        {
            ...
            stream.WriteLine(_isAutoPlayModeEnabled.ToString().ToLower());
            stream.Close();
